  ...
  return (
    <div className="flex flex-col lg:flex-row px-2 lg:px-8 pt-2 md:pt-0 min-h-screen">
      ...
      <div className="lg:w-[55.5%] relative lg:fixed h-[34rem] md:h-screen md:ml-8">
        <video
          className="flex md:hidden w-full h-full object-cover bg-[#f5f4f0] rounded-lg md:rounded-none shadow-lg shadow-[#f5f4f0]"
        ...
        <video
          ...
          className="hidden md:flex w-full h-full object-cover bg-[#f5f4f0] rounded-lg md:rounded-none shadow-lg shadow-[#f5f4f0]"
          src="https://res.cloudinary.com/ddxssowqb/video/upload/v1725138194/sample_vid_2_y6q8xo.mp4"
          controls
          autoPlay
          loop
      ...
      <div className="lg:w-[41%] px-5 lg:ml-[60%] mt-8 lg:mt-0 md:pl-10 flex flex-col justify-between">
        <div>
          ...
          <p className="mt-4 text-[17px] text-[#444a52] font-medium font-averta">
